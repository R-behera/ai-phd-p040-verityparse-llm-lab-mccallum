...
This project targets the intersection of **ML, NLP, information extraction (CRFs), structured prediction** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Andrew McCallum's research area.
...
Advisor-specific slice: **ML, NLP, information extraction (CRFs), structured prediction**.
