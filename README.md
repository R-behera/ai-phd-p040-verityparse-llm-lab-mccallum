# Socratic Agent Observatory: NLP for McCallum-Aligned Research

A professor-outreach research proposal aligned with **Andrew McCallum** at **University of Massachusetts Amherst**.
...
This repo has its own runnable prototype method: **McCallumMinimalNlpTraceEngine**.
...
How can a focused, reproducible artifact around **NLP** create useful research infrastructure for a lab working on **ML, NLP, information extraction (CRFs), structured prediction**?

## Advisor Fit

- **Professor:** Andrew McCallum
- **University:** University of Massachusetts Amherst
- **Program:** Manning College of Information & Computer Sciences
- **CSV research area:** ML, NLP, information extraction (CRFs), structured prediction
- **Representative paper:** Conditional Random Fields: Probabilistic Models for Segmenting and Labeling Sequence Data; 2001; ICML
- **Scholar link:** https://scholar.google.com/scholar?q=Conditional+Random+Fields%3A+Probabilistic+Models+for+Segmenting+and+Labeling+Sequence+Data
