...
This repository is currently a **research proposal and execution scaffold**, not a completed result. Use it to show Professor McCallum that you understand the research area and can contribute a concrete, reproducible artifact.
...
- **Research area from CSV:** ML, NLP, information extraction (CRFs), structured prediction
- **Representative paper from CSV:** Conditional Random Fields: Probabilistic Models for Segmenting and Labeling Sequence Data; 2001; ICML
