...
**Subject:** Prospective PhD applicant interested in grounded language systems and evaluation (NLP)

Dear Professor McCallum,

I am preparing for Fall 2027 PhD applications and have been studying your work around **ML, NLP, information extraction (CRFs), structured prediction**. I was especially interested in the direction represented by **Conditional Random Fields: Probabilistic Models for Segmenting and Labeling Sequence Data; 2001; ICML**.

I put together a small research scaffold for a project I would like to develop further: **Socratic Agent Observatory: NLP for McCallum-Aligned Research**. The goal is to build **a citation-faithful RAG and evaluation harness for advisor-domain papers** focused on **NLP**, with reproducible baselines, ablations, and failure analysis rather than a demo-only implementation.
...
Project summary: https://github.com/R-behera/ai-phd-p040-verityparse-llm-lab-mccallum
...
Public repo URL: https://github.com/R-behera/ai-phd-p040-verityparse-llm-lab-mccallum
