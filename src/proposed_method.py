...
METHOD_SPEC = {
    "algorithm_id": "P040-Mccallum-Nlp",
    "algorithm_name": "McCallumMinimalNlpTraceEngine",
    ...
    "decision_rule": "Rank seed cases by language-specific priority score with McCallum-aligned focus term 'NLP'.",
    "review_threshold": 0.39,
    "shift_weights": {
        "viewpoint": 0.05,
        "context": 0.13,
        "annotation": 0.11,
